...
then
    BRANCH="env%2Fqa1"
    ruleset=$(gh api /repos/org-mushroom-kingdom/bash-git-script/branches/env%2Fqa1/protection -H "Accept: application/vnd.github+json" -H "X-GitHub-Api-Version: 2022-11-28" --header "Authorization: token $REPO_READ_TOKEN")
